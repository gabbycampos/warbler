...
class UserModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # user1 = User.signup("test1@test.com", "test1user", "password", None)
    ...
    def test_repr(self):
        ...
        self.assertEqual(str(self.u1),self.u1.__repr__())
    ...
    def test_valid_signup(self):
        u_test = User.signup("testtesttest", "testtest@test.com", "password", None, None, None, None)
        uid = 9999
        u_test.id = uid
        db.session.commit()
    ...
    def teset_valid_authentication(self):
