...
class MessageViewsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.testuser = User.signup(username="testuser", email="test@test.com", password="testuser", image_url=None, header_image_url=None, bio=None, location=None)
    ...
    def setup_likes(self):
        m1 = Message(text="hey all", user_id=self.testuser_id)
        m2 = Message(text="look at me", user_id=self.testuser_id)
        m3 = Message(id=9876, text="happy v-day", user_id=self.u1_id)
    ...
    def test_add_like(self):
        ...
        with self.client as c:
            ...
            self.assertEqual(resp.status_code, 200)
            # fails since the app does not return a 200 but it does like a comment
